...
//
//xdescribe('Father.ComponentPackage', function() {
//
//  it('normal', function() {
...
//    pkg.files['src/index.js'].dependencies.should.eql(['each', './test.js']);
...
//    pkgDeps['each'].should.eql(pkg.getPackage('each@0.2.3'));
//    pkgDeps['to-function'].should.eql(pkg.getPackage('to-function@1.0.0'));
//
//    var each = pkg.getPackage('each@0.2.3');
...
//    eachDeps['type'].should.eql(pkg.getPackage('type@1.0.0'));
//    eachDeps['to-function'].should.eql(pkg.getPackage('to-function@2.0.0'));
//
//    var type = pkg.getPackage('type@1.0.0');
...
//
//    var props = pkg.getPackage('props@1.1.2');
...
//
//    var toFunction = pkg.getPackage('to-function@1.0.0');
...
//
//    var toFunction2 = pkg.getPackage('to-function@2.0.0');
...
//    toFunction2Deps['props'].should.eql(pkg.getPackage('props@1.1.2'));
//  });
//
